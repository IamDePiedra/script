...
local function CreateProfessionalGUI()
    ...
    Logo.Image = "rbxassetid://102621558434211"
    ...
    Title.Text = "Kim_Dawude 2X FASTER"
...
-- APS SLIDER
local apsSlider = CreateSlider(content, "Attacks Per Second:", 1, 3000, 400, 0.36, function(value)
    attacksPerSecond = value
    attackCooldown = 1 / attacksPerSecond
end)

-- Range SLIDER
local rangeSlider = CreateSlider(content, "Attack Range (studs):", 1, 250, 50, 0.48, function(value)
    attackRange = value
end)
...
footerLabel.Text = "Kim_Dawude 2X FASTER v2.4 | Press E to toggle"
